...
- [src/liquid-sellhub.langium](src/liquid-sellhub.langium) -  The grammar definition of your language
- [src/liquid-sellhub-module.ts](src/liquid-sellhub-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/liquid-sellhub-validator.ts](src/liquid-sellhub-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/liquid-sellhub.monarch.ts](src/syntaxes/liquid-sellhub.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/liquid-sellhub.tmLanguage.json](syntaxes/liquid-sellhub.tmLanguage.json) - Textmate based syntax highlighting instructions.
