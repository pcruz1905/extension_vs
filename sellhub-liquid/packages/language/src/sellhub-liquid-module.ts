...
import {
  SellhubLiquidValidator,
  registerValidationChecks,
} from "./sellhub-liquid-validator.js";
 ...
 */
export type SellhubLiquidServices = LangiumServices &
  SellhubLiquidAddedServices;
 ...
 */
export const SellhubLiquidModule: Module<
  SellhubLiquidServices,
  PartialLangiumServices & SellhubLiquidAddedServices
> = {
  services: {
    ConfigService: (services) => {
      ...
      if (
        services.shared &&
        services.shared.workspace &&
        services.shared.workspace.ConfigurationProvider
      ) {
        configService.setConfigurationProvider(
          services.shared.workspace.ConfigurationProvider
        );
      }
  ...
  //       services.providers.IslandsCompletionProvider,
  //   },
};
 ...
 */
export function createSellhubLiquidServices(
