...
- [src/sellhubliquid.langium](src/sellhubliquid.langium) -  The grammar definition of your language
- [src/sellhubliquid-module.ts](src/sellhubliquid-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/sellhubliquid-validator.ts](src/sellhubliquid-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/sellhubliquid.monarch.ts](src/syntaxes/sellhubliquid.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/sellhubliquid.tmLanguage.json](syntaxes/sellhubliquid.tmLanguage.json) - Textmate based syntax highlighting instructions.
