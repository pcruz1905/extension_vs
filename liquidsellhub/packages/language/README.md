...
- [src/sellhub-liquid.langium](src/sellhub-liquid.langium) -  The grammar definition of your language
- [src/sellhub-liquid-module.ts](src/sellhub-liquid-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/sellhub-liquid-validator.ts](src/sellhub-liquid-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/sellhub-liquid.monarch.ts](src/syntaxes/sellhub-liquid.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/sellhub-liquid.tmLanguage.json](syntaxes/sellhub-liquid.tmLanguage.json) - Textmate based syntax highlighting instructions.
